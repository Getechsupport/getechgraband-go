...
APP_DOMAINS = ['gedu.demo.getech-test.uk']
...
ON_PROD = ON_GAE and ('grab-and-go-269509' in APPLICATION_ID)
...
ADMIN_EMAIL = 'googlesupport@gedu.demo.getech-test.uk'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@gedu.demo.getech-test.uk'
...
SUPERADMINS_GROUP = 'technical-admins@gedu.demo.getech-test.uk'
